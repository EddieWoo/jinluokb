...
//	private GifView gifView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.stepactivity);  //设置当前屏幕

		if (SettingActivity.sharedPreferences == null) {
			SettingActivity.sharedPreferences = this.getSharedPreferences(
					SettingActivity.SETP_SHARED_PREFERENCES,
...
//			gifView.showCover();
	...
	private void init() {
		...
		step_length = SettingActivity.sharedPreferences.getInt(
				SettingActivity.STEP_LENGTH_VALUE, 70);
		weight = SettingActivity.sharedPreferences.getInt(
				SettingActivity.WEIGHT_VALUE, 50);
