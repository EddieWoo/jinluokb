...
public class Archive extends FragmentActivity {
	...
	private void initView() {
		...
		FamilyArchiveFragment familyarchivef = new FamilyArchiveFragment();
		FriendArchiveFragment friendarchivef = new FriendArchiveFragment();
		ClientArchiveFragment clientarchivef = new ClientArchiveFragment();
		ColleagueArchiveFragment colleaguearchivef = new ColleagueArchiveFragment();
		lists.add(familyarchivef);
		lists.add(friendarchivef);
		lists.add(clientarchivef);
		lists.add(colleaguearchivef);
