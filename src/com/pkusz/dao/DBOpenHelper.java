...
public class DBOpenHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL(DBInfoConfig.CREATE_TABLE_FRIEND);
		db.execSQL(DBInfoConfig.CREATE_TABLE_COLLEAGUE);
		db.execSQL(DBInfoConfig.CREATE_TABLE_FAMILY);
		db.execSQL(DBInfoConfig.CREATE_TABLE_CLIENT);		
