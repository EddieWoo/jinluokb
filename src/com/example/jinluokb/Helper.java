...
public class Helper extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		int[] img = new int[] { R.drawable.help1, R.drawable.hh1,R.drawable.hh2,R.drawable.hh3,R.drawable.hh4,R.drawable.hh5,R.drawable.hh6,R.drawable.hh7};
		...
		main = (ViewGroup) inflater.inflate(R.layout.pager_layout, null);
		...
		for (int i = 0; i < pageViews.size(); i++) {
			...
			imageView = new ImageView(Helper.this);
			//设置每个小圆点的宽高
